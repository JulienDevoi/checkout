          ...
          <div className="max-w-3xl mx-auto">
              <div className="text-center pb-12 md:pb-16">
                <h1 className="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-linear-to-r from-zinc-500 via-zinc-900 to-zinc-900 pb-4">
                  The  <em className="italic relative inline-flex justify-center items-center text-zinc-900"> <svg className="absolute fill-zinc-300 w-[calc(100%+1rem)] -z-10" xmlns="http://www.w3.org/2000/svg" width="223" height="62" viewBox="0 0 223 62" aria-hidden="true" preserveAspectRatio="none">
                    ...
                    </svg> last checkout </em>  you'll ever need
                </h1>
                <p className="text-lg text-zinc-500 mb-8">
                Accept stablecoins with a one‑link checkout. <br />Lower fees, no chargebacks, instant settlement, and built‑in accounting & compliance.
                </p>
                <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                  <div>
                    <Link className="btn text-zinc-100 bg-zinc-900 hover:bg-zinc-800 w-full shadow-sm" href="/request-demo">Create your first Pay Link</Link>
                  </div>
                  <div>
                    <a className="btn text-zinc-600 bg-white hover:text-zinc-900 w-full shadow-sm" href="#0">Book a demo</a>
                  </div>
                </div>
              </div>
          </div>
