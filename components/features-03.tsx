          ...
          <div className="lg:flex space-y-12 lg:space-y-0 lg:space-x-12 xl:space-x-24">
            ...
            <div className="lg:max-w-none lg:min-w-[524px]">
              <div className="mb-8">
                ...
                <h3 className="font-inter-tight text-3xl font-bold text-zinc-200 mb-4">Built for modern online businesses</h3>
                <p className="text-lg text-zinc-500">Whether you sell softwares, products, services or content, Checkout fits your flow.</p>
              </div>
              {/* Tabs buttons */}
              <div className="mb-8 md:mb-0 space-y-2">
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">🛍️ SaaS & E-commerce</div>
                    <div className="text-zinc-500">Lower fees, faster payouts, no blocked accounts.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">💼 Freelancers & Agencies</div>
                    <div className="text-zinc-500">Get paid in stablecoins, globally, with instant ledgering.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="font-inter-tight text-lg font-semibold text-zinc-200 mb-1">🎥 Content creators</div>
                    <div className="text-zinc-500">Keep more of your earnings from each sale.</div>
                  </div>
                </button>
              </div>
            </div>
