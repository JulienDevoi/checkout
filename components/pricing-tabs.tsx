      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative max-w-3xl mx-auto text-center pb-12">
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-zinc-900 mb-4">Fair, simple pricing for all</h2>
            <p className="text-lg text-zinc-500">No setup fee. No hidden fees. No surprises.</p>
          </div>
          ...
          <div className="pb-12 md:pb-20">
            ...
            <div className="max-w-md mx-auto grid gap-6 lg:grid-cols-1 items-start">
